...
<div style="margin-top: 20px;">
    <a href="/signin/{{ $signinId->id }}/change" style="font-size: 18px; padding: 8px 16px; background-color: #007bff; color: white; border: none; border-radius: 4px; cursor: pointer; text-decoration: none;">Change Username</a>
</div>
